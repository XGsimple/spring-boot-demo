...
import com.xkcoding.cache.redis.utils.JsonUtils;
import com.xkcoding.cache.redis.utils.ProtoStuffSerializerUtil;
...
public class RedisUtil {
    ...
    public static void setRedisTemplate(StringRedisTemplate strRedisTemplate) {
     ...
     * @return
     */
    public static <T> List<T> getListCache(String key, Class<T> targetClass) {
     ...
     * @return
     */
    public static <T> boolean putListCacheWithExpireTime(String key, List<T> objList, long expireTime) {
