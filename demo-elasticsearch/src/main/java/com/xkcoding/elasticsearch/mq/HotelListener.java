package com.xkcoding.elasticsearch.mq;

import com.xkcoding.elasticsearch.constants.HotelMqConstants;
...
public class HotelListener {
    ...
    @RabbitListener(bindings = @QueueBinding(value = @Queue(name = HotelMqConstants.INSERT_QUEUE_NAME),
    ...
    @RabbitListener(bindings = @QueueBinding(value = @Queue(name = HotelMqConstants.DELETE_QUEUE_NAME),
                                             exchange = @Exchange(name = HotelMqConstants.EXCHANGE_NAME,
                                                                  type = ExchangeTypes.TOPIC),
