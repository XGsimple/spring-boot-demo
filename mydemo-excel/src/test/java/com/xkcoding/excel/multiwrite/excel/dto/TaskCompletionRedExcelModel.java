...
@AllArgsConstructor
@Builder
public class TaskCompletionRedExcelModel extends ValidateErrorHead {
    @ExcelProperty(index = 0, value = {"大型活动>任务达成红榜-分部", "分部名称"})
    @NotBlank(message = "分部名称不能为空")
    private String key;

    @ExcelProperty(index = 1, value = {"大型活动>任务达成红榜-分部", "任务达成率(%)"})
    ...
    @ExcelProperty(index = 2, value = {"大型活动>任务达成红榜-分部", "排名"})
