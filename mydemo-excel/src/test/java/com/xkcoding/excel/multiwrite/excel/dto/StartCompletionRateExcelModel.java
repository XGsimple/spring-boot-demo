...
@AllArgsConstructor
@Builder
public class StartCompletionRateExcelModel extends ValidateErrorHead {

    @ExcelProperty(index = 0, value = {"加盟店>开业完成率", "开业完成率(%)"})
    @NotBlank(message = "开业完成率不能为空")
    @Pattern(regexp = PERCENT, message = "开业完成率请填写数字")
