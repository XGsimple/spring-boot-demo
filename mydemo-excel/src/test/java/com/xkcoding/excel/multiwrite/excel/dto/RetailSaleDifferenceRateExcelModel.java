...
@AllArgsConstructor
@Builder
public class RetailSaleDifferenceRateExcelModel extends ValidateErrorHead {
    @ExcelProperty(index = 0, value = {"一心便利>零售进销差率", "零售进销差率(%)"})
    @NotBlank(message = "零售进销差率不能为空")
    @Pattern(regexp = PERCENT, message = "零售进销差率请填写数字")
    ...
    @ExcelProperty(index = 1, value = {"一心便利>零售进销差率", "进销差率同比(%)"})
    @NotBlank(message = "进销差率同比不能为空")
    @Pattern(regexp = PERCENT, message = "进销差率同比请填写数字")
    ...
    @ExcelProperty(index = 2, value = {"一心便利>零售进销差率", "进销差率环比(%)"})
    @NotBlank(message = "进销差率环比不能为空")
    @Pattern(regexp = PERCENT, message = "进销差率环比请填写数字")
