...
@AllArgsConstructor
@Builder
public class RetailSaleCompletionRateExcelModel extends ValidateErrorHead {
    @ExcelProperty(index = 0, value = {"一心便利>零售销售完成率", "零售销售完成率(%)"})
    @NotBlank(message = "零售销售完成率不能为空")
    @Pattern(regexp = PERCENT, message = "零售销售完成率请填写数字")
    ...
    @ExcelProperty(index = 1, value = {"一心便利>零售销售完成率", "销售同比(%)"})
    ...
    @ExcelProperty(index = 2, value = {"一心便利>零售销售完成率", "销售环比(%)"})
