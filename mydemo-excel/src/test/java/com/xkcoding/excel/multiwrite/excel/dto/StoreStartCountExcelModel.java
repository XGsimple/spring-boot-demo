...
@AllArgsConstructor
@Builder
public class StoreStartCountExcelModel extends ValidateErrorHead {

    @ExcelProperty(index = 0, value = {"加盟店>开业门店数", "开业门店数(家)"})
    @NotBlank(message = "开业门店数不能为空")
    @Pattern(regexp = PERCENT, message = "开业门店数请填写数字")
