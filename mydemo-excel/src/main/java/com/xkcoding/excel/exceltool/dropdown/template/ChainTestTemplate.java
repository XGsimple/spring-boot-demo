...
import com.xkcoding.excel.exceltool.dropdown.service.impl.AreaChainDropDownService;
import com.xkcoding.excel.exceltool.dropdown.service.impl.TestChainDropDownService;
import lombok.Data;
...
public class ChainTestTemplate {
    ...
    @ExcelProperty("省")
    @ChainDropDownFields(isRoot = true,
                         sourceClass = AreaChainDropDownService.class,
                         type = ChainDropDownType.AREA,
                         params = {"1"})
